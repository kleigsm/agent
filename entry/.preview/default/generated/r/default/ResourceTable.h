...
const int32_t STRING_TAB_CHAT = 0x01000005;
const int32_t STRING_TAB_FILES = 0x01000006;
const int32_t STRING_TAB_SETTINGS = 0x01000007;
const int32_t STRING_TAB_TERMINAL = 0x01000008;
const int32_t COLOR_START_WINDOW_BG = 0x0100000a;
